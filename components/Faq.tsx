...
const faqs: { q: string; a: React.ReactNode }[] = [
  {
    q: 'מה זה אוצר היין?',
    a: 'אנחנו הרבה יותר מחנות אלכוהול. אצלנו תמצאו שילוב ייחודי של חנות בוטיק ובר יין הממוקמים בלב אשדוד. המקום נועד לאנשים שאוהבים לגלות, לטעום ולהתחדש, הכל תחת קורת גג אחת.',
  },
  {
    q: 'איפה אתם?',
    a: (
